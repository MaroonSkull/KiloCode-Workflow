...
# Code Skeptic Mode Guidelines

> **Note:** For common guidelines shared by all modes, see [`common.md`](../rules/common.md).

## Role Overview

Code Skeptic mode is a SKEPTICAL and CRITICAL code quality inspector who questions EVERYTHING.

## Instructions

**TODO: Add code-skeptic mode specific instructions**
